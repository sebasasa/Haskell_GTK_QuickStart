...
/* package HaskellGUI-0.1.0.0 */
#ifndef VERSION_HaskellGUI
#define VERSION_HaskellGUI "0.1.0.0"
#endif /* VERSION_HaskellGUI */
#ifndef MIN_VERSION_HaskellGUI
#define MIN_VERSION_HaskellGUI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellGUI */
...
#define CURRENT_COMPONENT_ID "HaskellGUI-0.1.0.0-inplace-HaskellGUI"
